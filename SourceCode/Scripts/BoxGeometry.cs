...
* Date:         July 14, 2018
* Description:  This script, when attached to a 3D Cube GameObject, will calculate various
*               geometric properties for the cube it is attached to, such as CG, corner
